	...
	<div class="container-fluid">
		<div class="page-titles">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Property View</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-xl-12 col-xxl-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Add Property View</h4>
					</div>
					<div class="card-body">
						<form role="form" action="{{ route('property-view.store') }}" method="POST">
						@csrf
