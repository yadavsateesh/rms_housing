	...
	<div class="container-fluid">
		<div class="page-titles">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Furnishing Status</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-xl-12 col-xxl-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Add Furnishing Status</h4>
					</div>
					<div class="card-body">
						<form role="form" action="{{ route('furnishing-status.store') }}" method="POST">
						@csrf
